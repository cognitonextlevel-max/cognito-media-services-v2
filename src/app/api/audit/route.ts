...
export async function POST(req: Request) {
    try {
        ...
        const basePrompt = `You are the lead architect of Cognito Media & Business Solutions, an elite AI systems and growth engineer. Your job is to produce a completely unique, practical, and highly strategic SEO audit for the target business, plus competitor analysis against the closest competing pages matching their profile.
