...
const modules = [
  ...
  },
  {
    ...
    description: "24/7 intelligent phone answering systems (Vapi/ElevenLabs) installed so you never miss a lead.",
  ...
  },
  {
    ...
    subtitle: "Workflows",
    description: "Claude and Antigravity workflow integration to handle your invoicing, emails, and back-office chaos.",
  ...
  },
  {
    ...
    description: "We physically install Claude, ElevenLabs, and automation tools at your business — then train your entire team until they're confident.",
