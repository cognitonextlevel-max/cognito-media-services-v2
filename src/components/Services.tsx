            ...
            <div className="max-w-[1800px] mx-auto px-4 sm:px-6 md:px-24 relative z-10">
                <div className="flex flex-col mb-16 sm:mb-24 md:mb-32 relative">
                    ...
                    <motion.h2
                        ...
                        className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-cabinet font-black uppercase mb-8 sm:mb-12 break-words"
                    >
                        THE 4 SYSTEMS <br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 relative">
                    {services.map((service, idx) => (
                        <motion.div
                            ...
                            className="group relative bg-[#050505] p-6 sm:p-10 md:p-14 border border-zinc-900 overflow-hidden h-full flex flex-col transition-all duration-700 hover:border-cyan-500/40 hover:shadow-[0_0_50px_rgba(0,255,255,0.05)] cursor-default"
                        >
                            ...
                            {/* Corner Accents */}
                            <div className="absolute top-0 left-0 w-3 h-3 sm:w-4 sm:h-4 border-t-2 border-l-2 border-zinc-800 transition-colors duration-500 group-hover:border-cyan-400/60"></div>
                            <div className="absolute top-0 right-0 w-3 h-3 sm:w-4 sm:h-4 border-t-2 border-r-2 border-zinc-800 transition-colors duration-500 group-hover:border-cyan-400/60"></div>
                            <div className="absolute bottom-0 left-0 w-3 h-3 sm:w-4 sm:h-4 border-b-2 border-l-2 border-zinc-800 transition-colors duration-500 group-hover:border-cyan-400/60"></div>
                            <div className="absolute bottom-0 right-0 w-3 h-3 sm:w-4 sm:h-4 border-b-2 border-r-2 border-zinc-800 transition-colors duration-500 group-hover:border-cyan-400/60"></div>

                            <div className="relative z-10 w-full flex flex-col h-full">
                                <div className="mb-8 sm:mb-14 flex items-center justify-between">
                                    <div className="p-3 sm:p-5 bg-black border border-zinc-800 group-hover:border-cyan-400/60 group-hover:bg-cyan-950/20 transition-all duration-500 relative">
                                        {/* Status Dot */}
                                        <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 w-1.5 h-1.5 bg-zinc-800 rounded-full group-hover:bg-cyan-400 group-hover:shadow-[0_0_8px_rgba(0,255,255,1)] transition-colors duration-500"></div>
